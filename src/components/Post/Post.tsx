...
const Post = ({ post }: Props) => {
    ...
    return (
        <div className={styles.post}>
            <Link className={styles["post__homeButton"]} to="/" onClick={() => gtagTrack("HomeLink", "click", "home")}>
                {siteTitle}
            </Link>
            ...
            <div className={styles["post__comments"]}>
                ...
                {showComment && <Comments postSlug={slug} postTitle={post.frontmatter.title} fbCommentUrl={fbCommentUrl} />}
            </div>
        </div>
    );
};
